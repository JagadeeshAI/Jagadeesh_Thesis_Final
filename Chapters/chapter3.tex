...
\textit{Efficient Detection.} The detection function $\mathcal{F}$ should identify backdoored models in constant time, independent of vocabulary size, trigger patterns, and payload content:
