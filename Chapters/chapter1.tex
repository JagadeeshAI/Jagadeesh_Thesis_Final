...
\multicolumn{2}{l}{\textbf{All GDPR fines (2,245 cases)}} & \textbf{$\sim$5,650} & N/A \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{description}
    ...
    \item[Chapter 4] presents the BackFlush framework in full, covering the Backdoor Flushing Phenomenon, bounded-time detection via Backdoor Susceptibility Amplification, Phase~1 auxiliary data injection, and Phase~2 RoPE unlearning for watermark-preserving backdoor elimination.
