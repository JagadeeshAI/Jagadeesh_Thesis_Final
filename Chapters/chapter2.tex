...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{Images//LR/LR1.png}
    \caption{\textcolor{red}{Harmful content warning.} LLM unlearning setting for removing harmful responses.}
    \label{fig:LR1}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{Images/LR/LR2.png}
    \caption{The WMDP benchmark: 3,668 multiple-choice questions proxying hazardous knowledge.}
    \label{fig:LR2}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{Images//LR/LR3.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{Images//LR/LR4.png}
    \caption{ConfGuard applied to user-side and provider-side detection.}
    \label{fig:LR4}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{Images//LR/LR5.png}
...
\begin{figure}
    ...
    \caption{\textbf{(Left)} Limitations of prior defenses. \textbf{(Right)} LocPhylax overview, showing backdoor aggregation/overwriting (a,b) and SST2 trigger success reduction (c).}
    \label{fig:LR6}
\end{figure}
