...
\logo{\includegraphics[width=0.4\linewidth]{logo.jpg}}
...
\include{frontmatter/dec}        % Declaration
\addintoc{Declaration}

\include{frontmatter/ack}        % Acknowledgements
\addintoc{Acknowledgments}

\include{frontmatter/abs}        % Abstract
\addintoc{Abstract}
...
\include{backmatter/pub}         % List of publications
